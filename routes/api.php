...
Route::get("/profile/{id}", [ProfileController::class, 'get'])->middleware(corsHandle::class);
Route::get("/quiz/new/{id}", [QuizController::class, 'new'])->middleware(corsHandle::class);
Route::post("/quiz/save", [QuizController::class, 'save'])->middleware(corsHandle::class);
Route::get("/quiz/all/{id}", [QuizController::class, 'get_all'])->middleware(corsHandle::class);
